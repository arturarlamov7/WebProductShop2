...
<h3 class="w-100 text-center  my-5">Добавить товар</h3>
        <div class="" style="width: 50rem; margin: 0 auto">
            ...
            <form action="createFurniture" method="POST">
                  ...
                  <div class="mb-3 row">
                        <label for="size" class="col-sm-3 col-form-label"> Вес:</label>
                    <div class="col-sm-9">
                  ...
                  <div class="form-floating">
                    ...
                    <label for="text">Описание к товару</label>
                  </div><br>
                  <div class="mb-3 row">
                  ...
                  <div class="mb-3 row">
                    <label for="color" class="col-sm-3 col-form-label">Дополнительное:</label>
                    <div class="col-sm-9">
